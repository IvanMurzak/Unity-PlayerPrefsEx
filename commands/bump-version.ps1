...
$VersionFiles = @(
    ...
    @{
        Path        = "Installer/Assets/PlayerPrefsEx Installer/Installer.cs"
    ...
    @{
        ...
        Pattern     = "https://github\.com/IvanMurzak/Unity-PlayerPrefsEx/releases/download/[\d\.]+/PlayerPrefsEx-Installer\.unitypackage"
        Replace     = "https://github.com/IvanMurzak/Unity-PlayerPrefsEx/releases/download/{VERSION}/PlayerPrefsEx-Installer.unitypackage"
