...
using Extensions.Unity.PlayerPrefsEx.Installer.SimpleJSON;

namespace Extensions.Unity.PlayerPrefsEx.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/Extensions.Unity.PlayerPrefsEx.Installer.Tests/test_manifest.json";
        const string PackageId = "extensions.unity.playerprefsex";
